...
//services.AddSingleton<IRepository<BoardGame>, ListRepository<BoardGame>>();

services.AddSingleton<IRepository<BoardGame>,  SqlRepository<BoardGame>>();

//when using sqlserver change this
services.AddDbContext<BookShelfAppDbContext>(options =>
        options.UseInMemoryDatabase("StorageAppDb"));
